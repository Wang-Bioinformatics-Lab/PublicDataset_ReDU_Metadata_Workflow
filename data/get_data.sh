...
download_file "https://github.com/EnvironmentOntology/envo/blob/master/subsets/biome-hierarchy.owl" "${SCRIPT_DIR}/biome-hierarchy.owl"
download_file "https://github.com/EnvironmentOntology/envo/blob/master/subsets/material-hierarchy.owl" "${SCRIPT_DIR}/material-hierarchy.owl"
